    ...
    <div className="bg-primary-sand min-h-screen pb-32 text-primary-navy">
      ...
      <section className="py-32 px-6 container mx-auto max-w-6xl relative z-10">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="glass-cinematic p-12 rounded-2xl hover:shadow-[0_0_40px_rgba(212,175,55,0.15)] hover:border-accent-gold transition-all duration-300 flex flex-col items-center text-center group">
            <div className="w-20 h-20 bg-white/5 text-accent-gold flex items-center justify-center rounded-full mb-8 shadow-md border border-white/10 group-hover:scale-110 transition-transform duration-500">
              <BookOpen className="w-8 h-8 stroke-[1.5]" />
            </div>
            <h2 className="text-3xl font-bold mb-6 font-serif text-white tracking-tight group-hover:text-accent-gold transition-colors">{isEs ? 'Estudio Bíblico' : 'Bible Study'}</h2>
            <p className="text-stone-300 mb-10 leading-relaxed font-medium text-lg">
              {isEs 
            ...
            <blockquote className="border-l-4 border-accent-gold pl-6 text-stone-400 italic font-serif text-xl font-bold leading-tight">
              {isEs 
          ...
          <div className="glass-cinematic p-12 rounded-2xl hover:shadow-[0_0_40px_rgba(212,175,55,0.15)] hover:border-accent-gold transition-all duration-300 flex flex-col items-center text-center group">
            ...
            <h2 className="text-3xl font-bold mb-6 font-serif text-white tracking-tight group-hover:text-accent-gold transition-colors">{isEs ? '¿Cómo Alabar a Dios?' : 'How to Praise God?'}</h2>
            <p className="text-stone-300 mb-10 leading-relaxed font-medium text-lg">
              {isEs 
