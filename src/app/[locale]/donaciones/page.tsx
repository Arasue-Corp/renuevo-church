              ...
              <div className="flex flex-col sm:flex-row items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-stone-700 mb-6 font-medium text-base leading-relaxed">
                    {isEs ? 'Envía tu donación de forma segura directamente desde la app de tu banco usando nuestro número institucional.' : 'Send your donation securely directly from your bank app using our institutional number.'}
                  </p>
            ...
            <div className="group bg-white p-8 md:p-10 rounded-2xl shadow-xl shadow-stone-200/50 border border-stone-100 transition-all hover:border-accent-gold/50 hover:shadow-2xl">
              <div className="flex flex-col sm:flex-row items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-stone-700 mb-6 font-medium text-base leading-relaxed">
                    {isEs ? 'Haz tu cheque pagadero a "Renuevo Church" y envíalo a nuestra dirección postal en Arizona.' : 'Make your check payable to "Renuevo Church" and mail it to our physical address in Arizona.'}
                  </p>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-stone-300 mb-8 font-medium text-base leading-relaxed">
                    {isEs ? 'Utiliza tu tarjeta de crédito, débito o billetera digital a través de nuestra pasarela segura.' : 'Use your credit, debit card, or digital wallet through our secure gateway.'}
                  </p>
