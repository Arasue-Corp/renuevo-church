  ...
  if (businesses.length === 0) {
    businesses = [
      ...
      { 
        ...
        description: 'Somos una empresa que crea soluciones innovadoras y productos de calidad para facilitar la vida de las personas, desde aplicaciones digitales útiles hasta bienes de uso diario.', 
        descriptionEn: 'We are a company that creates innovative solutions and quality products to make people\'s lives easier, from useful digital applications to everyday goods.', 
