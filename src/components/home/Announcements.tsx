    ...
    <section className="py-32 bg-[#FAF9F6] border-t border-stone-200">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="mt-16 text-center">
          <Link href={`/${locale}/anuncios`} className="inline-flex justify-center items-center px-10 py-5 bg-white text-primary-navy rounded-xl font-bold text-sm tracking-widest uppercase shadow-md hover:shadow-xl hover:text-accent-gold transition-all border border-stone-200">
